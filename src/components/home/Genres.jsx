                    ...
                    {genres.map((genre, i) => (
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="relative w-14 h-14 rounded-full bg-[#F3DCC9] flex items-center justify-center mx-auto text-2xl group-hover:bg-[#C4622D] group-hover:scale-110 transition-all duration-300">
                                    <span className="group-hover:grayscale-0 group-hover:brightness-[10]">
                                        {genre.icon}
                                    </span>
                                </div>
